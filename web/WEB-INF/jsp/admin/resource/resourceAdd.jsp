...
<div class="clearfix" id="add_picture">
    <div class="page_right_style" style="left: 0px">
        <div class="type_title">添加资源</div>
        <form action="${pageContext.request.contextPath}/admin/resource/add" method="post" class="form form-horizontal" id="form-article-add">
...
<script type="text/javascript">
    ...
    // 表单提交函数
    function submitFormAsJson(formId, url, successMsg, isDraft = false) {
        // 阻止默认表单提交
        ...
        formData.forEach((value, key) => {
            // 处理数字字段
            if (key === 'userid' || key === 'quantity' || key === 'resourceprice') {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                layer.open({
                    ...
                    title: '错误详情',
                    area: ['600px', '400px'],
                    content: '<div style="padding:20px;word-wrap:break-word;">' + errorMsg + '</div>'
                });
            }
        });
    }
    ...
    function article_save_submit() {
        submitFormAsJson(
            'form-article-add',
            '${pageContext.request.contextPath}/admin/resource/add',
            '保存并提交成功'
        );
    }
    // 保存草稿
        ...
        $(function() {
            ...
            if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
                ...
                if (flashVersion) {
                    ...
                    $wrap.html('<a href="http://www.htmlsucai.com" target="_blank" border="0">' +
    ...
    laydate({
        ...
        // range: true,               // 开启范围选择（双日历）
        // min: '2024-01-01',         // 最小日期
        // max: '2025-12-31',         // 最大日期
        // done: function(value) {    // 选择后的回调
