...
<div class="page-content clearfix">
    <div class="alert alert-block alert-success">
        ...
        <i class="icon-ok green"></i>欢迎使用<strong class="green">后台管理系统<small>(v1.2)</small></strong>,你本次登陆时间为<span id="loginTime"></span>，登陆IP:${pageContext.request.remoteAddr}
    </div>
...
<script type="text/javascript">
    ...
    $(window).resize(function(){
        ...
        require.config({
            paths: {
                echarts: '${pageContext.request.contextPath}/static/assets/dist'
            }
        });
        require(
            [
